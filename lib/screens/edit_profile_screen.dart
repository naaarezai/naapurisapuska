...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  File? _selectedImage; // Valittu uusi kuva
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Profiili päivitetty!')),
        );
        Navigator.pop(context, true); // Kerro ProfileScreenille että tiedot muuttuivat
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Virhe päivityksessä: $e')),
        );
      }
    } finally {
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                validator: (value) =>
                    value == null || value.isEmpty ? 'Nimi ei voi olla tyhjä' : null,
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _isLoading
                      ...
                      : const Text('Tallenna muutokset', style: TextStyle(fontSize: 18)),
                ),
              ),
            ],
          ),
